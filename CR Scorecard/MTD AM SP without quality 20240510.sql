...
b."YTD Global Rank",
b."YTD Global Total Score"  "YTD Global Total Points",
rank() over ( order by b."YTD Global Total Score" desc ) sn
from(
select 
a."MONTH",
a."UCID",
...
select 
a."EMPLOYEE ID",
a."Global Rank" "YTD Global Rank",
a."Total Points" "YTD Global Total Score"
from (
select 
a."EMPLOYEE ID",
a."ASM_NAME" "TL NAME",

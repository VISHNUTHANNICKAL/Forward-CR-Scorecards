create or replace PACKAGE BODY CR_SC_MTD_AGNTS AS
...
,rank() over (  order by b."Total Points" desc ) sn
from(
select 
...
--where sn=1
where 
--month>= last_day('01-JAN-24') and
 "EMPLOYEE ID" in (vfusionid)
order by b.month--,b."YTD Global Rank"--,b."NAME"
--to_date(concat('01-',month)) asc
;
...
select 
to_char(a.month,'MON-YY') month ,a.ucid,a."EMPLOYEE ID",a.name,a."Team Lead",a.location,a.dept
,rank() OVER (PARTITION by a.month,a.dept ORDER BY (coalesce(a."Credits Score",0)+coalesce(case when a."Quality_Score"is null then 3.75 else a."Quality_Score" end,0)
+coalesce(case when a."Stella Star Score" is null then 4 else a."Stella Star Score" end,0)+coalesce(a."Adherence Score",0)+
coalesce(a."AHT Score",0)+ coalesce(a."Cms Defect Score",0))
 desc,a.dept,a.month ) "Global Rank"
,(coalesce(a."Credits Score",0)+coalesce(case when a."Quality_Score"is null then 3.75 else a."Quality_Score" end,0)
+coalesce(case when a."Stella Star Score" is null then 4 else a."Stella Star Score" end,0)+coalesce(a."Adherence Score",0)+
coalesce(a."AHT Score",0)+ coalesce(a."Cms Defect Score",0)) "Total Points"
,coalesce(a."Credit Per Hr",0) "Credit Per Hr" ,a."Credit Rank",a."Credits Score",a.CPH_TARGET
, coalesce (a."Quality Score",0)  "Quality Score"
,case when a."Quality Rank" is null then 1 else a."Quality Rank" end as "Quality Rank"
,coalesce(case when a."Quality_Score"is null then 3.75 else a."Quality_Score" end,0) as "Quality_Score",a.QUALITY_TARGET
...
a."UCID",
a."FUSION_ID" ,
upper(a."SUPV_NAME") "TL NAME" ,
upper(a."MANAGER_NAME") "ASM",
a."LOCATION",
a."DEPT",
...
a."COLLECTION_CALL_MODEL_DEFECT_TARGET",
a."Out Of"
--,b."YTD Global Rank",b."YTD Global Total Points"
--,row_number() over ( order by b."YTD Global Rank" ) sn
from(
select 
a."MONTH",
a."FUSION_ID",

  PROCEDURE CR_SC_MTD_AM (
    per in VARCHAR2,vfusionid4 in VARCHAR2, p_result OUT SYS_REFCURSOR) 
    is 
    period date;
  BEGIN
    -- TODO: Implementation required for PROCEDURE CR_SC_MTD_AGNTS.CR_SC_MTD_AGNTS
     ...
     if(vfusionid4 is null and period is null ) then
            OPEN p_result FOR  
